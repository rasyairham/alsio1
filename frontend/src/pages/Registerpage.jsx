...
const RegisterPage = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      alert(err.response?.data?.message || "Gagal Registrasi. Silakan coba lagi.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAF7F4] flex flex-col items-center justify-center p-6 antialiased" style={POP}>
        ...
        <div className="w-full max-w-[1050px] h-auto md:min-h-[583px] bg-white rounded-[32px] shadow-[0_1px_9px_rgba(0,0,0,0.15)] flex flex-col md:flex-row overflow-hidden relative z-10 transition-all duration-500 hover:shadow-[0_1px_9px_rgba(0,0,0,0.25)]">

          {/* LEFT PANEL */}
          <div
            className="hidden md:flex w-full md:w-[525px] bg-cover bg-center p-12 flex-col justify-end relative overflow-hidden z-20"
          ...
          >
            <div className="z-10">
              ...
              <p style={{ ...PJS, fontWeight: 700, fontSize: "16px", color: "#FFFFFF" }}>
                Ready to take your first mission?<br />
          ...
          <div className="w-full md:w-[525px] p-8 md:p-16 bg-white flex flex-col justify-center">
            <div className="mb-8 text-center md:text-left">
              <h2 className="text-3xl text-[#111] tracking-tight mb-2" style={{ ...PJS, fontWeight: 900, fontSize: "32px" }}>Create Account</h2>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="space-y-2 group">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-[#F8F7F5] border-2 border-transparent focus:border-[#C17A3A] focus:bg-white outline-none transition-all text-sm text-gray-800 placeholder:text-gray-300"
                    style={POP}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-[40px] rounded-2xl uppercase tracking-[2px] flex items-center justify-center gap-3 text-white shadow-lg transition-all transform active:scale-[0.98] overflow-hidden hover:opacity-90 disabled:opacity-50 mt-4"
                style={{
            ...
            <p className="mt-8 text-center text-gray-400 text-xs" style={{ ...POP, fontWeight: 500 }}>
              ...
              <Link to="/login" className="text-[#C17A3A] hover:underline underline-offset-4 font-bold" style={PJS}>
                Login Now
              </Link>
            </p>
          </div>
