...
// Notification Portal - Adjusted for Mobile
  ...
  return (
    ...
    >
      <div className="p-4 flex items-center gap-3">
        ...
        {notif.type !== 'confirm' && (
          <button onClick={(e) => { e.stopPropagation(); handleDismiss(); }} className="text-white/30 hover:text-white p-1"><X size={14} /></button>
        )}
      </div>
...
// ... (useNotify, Questpage logic logic same as your code)
const useNotify = () => {
...
const Questpage = () => {
  ...
  const handleComplete = async (taskId, questTitle, questXp) => {
    ...
    } catch (err) { notify.error("Claim Failed", "Failed to claim reward."); }
  };
  ...
  const handleDelete = (taskId) => {
    notify.confirm("Abandon this record?", "XP stays safe.", async () => {
      try {
        ...
        fetchData();
      } catch (err) { notify.error("Delete Failed", "Could not remove mission."); }
    });
  };
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-[#F8F5F2]"><div className="h-10 w-10 border-4 border-[#C29976] border-t-transparent rounded-full animate-spin"></div></div>;
      ...
      <div className="min-h-screen bg-[#F8F5F2] p-4 sm:p-6 pt-24 sm:pt-32 pb-24 font-sans text-zinc-900 selection:bg-[#C29976]/20 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-8 order-2 lg:order-1 space-y-6 sm:space-y-8">
            ...
            {/* Tab Switcher - Now Scrollable on very small screens */}
          ...
          <div className="lg:col-span-4 order-1 lg:order-2 space-y-6 sm:space-y-8">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="bg-white/5 p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] border border-white/5">
            ...
            {/* Wisdom Card - Hidden on small mobile to save vertical space? Or kept for style */}
            <div className="bg-white p-8 sm:p-10 rounded-[2.5rem] sm:rounded-[3.5rem] border border-zinc-100 shadow-sm relative overflow-hidden group">
